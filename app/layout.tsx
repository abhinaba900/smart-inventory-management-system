...
export const metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: "https://thirdeyesite.b-cdn.net/smart-inventory/Website.webp", // Path to your image in public folder
        width: 1200,
        height: 630,
  ...
  twitter: {
    ...
    images: ["https://thirdeyesite.b-cdn.net/smart-inventory/Website.webp"], // Same image path
  },
